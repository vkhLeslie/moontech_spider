...
/**
 * @description 爬取目标，爬取路径  希望大家有房有车
 * @author  chenxw
 */
public class ConstantsUtil {
     ...
     * 单个ip请求间隔，单位ms
     */
    public final static long TIME_INTERVAL = 1000; // 1秒
    // 淘宝首页
    public final static String INDEX_URL = "https://www.taobao.com/";
    // 链家网首页
    public final static String HOUSE_URL = "https://fs.lianjia.com/";
    // 人人车首页
    public final static String CAR_URL = "https://www.renrenche.com/";
    // 某详情页
    ...
    // 链家网楼盘列表
    public final static String HOUSE_LIST_URL = "https://fs.fang.lianjia.com/loupan/pg6/";
    // userAgentArray
