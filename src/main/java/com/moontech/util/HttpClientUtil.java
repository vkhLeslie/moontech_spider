...
//                                @Override
            ...
            SocketConfig socketConfig = SocketConfig.custom().setSoTimeout(ConstantsUtil.TIMEOUT).setTcpNoDelay(true).build();
...
//                @Override
            ...
            requestConfig = RequestConfig.custom().setSocketTimeout(ConstantsUtil.TIMEOUT).
                    setConnectTimeout(ConstantsUtil.TIMEOUT).
                    setConnectionRequestTimeout(ConstantsUtil.TIMEOUT).
    ...
    public static CloseableHttpResponse getResponse(HttpRequestBase request) throws IOException {
        ...
        request.setHeader("User-Agent", ConstantsUtil.userAgentArray[new Random().nextInt(ConstantsUtil.userAgentArray.length)]);
...
//		InputStream fis = HttpClientUtil.class.getResourceAsStream(name);
    ...
    public static org.apache.http.client.config.RequestConfig.Builder getRequestConfigBuilder(){
        return RequestConfig.custom().setSocketTimeout(ConstantsUtil.TIMEOUT).
                setConnectTimeout(ConstantsUtil.TIMEOUT).
                setConnectionRequestTimeout(ConstantsUtil.TIMEOUT).
                setCookieSpec(CookieSpecs.STANDARD);
    }
